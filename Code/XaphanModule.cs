    ...
    public class XaphanModule : EverestModule
    {
        ...
        private void onLevelUpdate(On.Celeste.Level.orig_Update orig, Level self)
        {
            ...
            if (ModSaveData.CountdownCurrentTime != -1)
            {
                ...
                {
                    self.Add(new CountdownDisplay(ModSaveData.CountdownCurrentTime, ModSaveData.CountdownShake, ModSaveData.CountdownExplode, true, ModSaveData.CountdownStartChapter, ModSaveData.CountdownStartRoom, ModSaveData.CountdownSpawn, ModSaveData.CountdownActiveFlag, ModSaveData.CountdownNotVisible, ModSaveData.CountdownEventsFlags)
                    {
                        PauseTimer = true
                    });
                }
