...
namespace Celeste.Mod.XaphanHelper.Events
{
    class E02_Boss : CutsceneEntity
    {
        ...
        public E02_Boss(Player player, Level level)
        {
            ...
            crumblePlatform1 = new CustomCrumbleBlock(bounds, Vector2.Zero, 24, 8, 2f, 0.6f, 0.6f, false, -1, texture: "objects/Xaphan/CustomCrumbleBlock/abyss_c", lightOccludeValue: 0.2f, canBypassSideCrumbleDelay: true);
            crumblePlatform2 = new CustomCrumbleBlock(bounds, Vector2.Zero, 24, 8, 2f, 0.6f, 0.6f,false, -1, texture: "objects/Xaphan/CustomCrumbleBlock/abyss_c", lightOccludeValue: 0.2f, canBypassSideCrumbleDelay: true);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (level.Session.GetFlag("boss_Challenge_Mode"))
                        {
                            ...
                            level.Displacement.AddBurst(refill.Center, 0.5f, 8f, 32f, 0.5f);
                            refill.RemoveSelf();
                            crumblePlatform3 = new CustomCrumbleBlock(bounds + new Vector2(128f, 152f), Vector2.Zero, 16, 8, 2f, 0.6f, 0.6f, false, -1, texture: "objects/Xaphan/CustomCrumbleBlock/abyss_c", lightOccludeValue: 0.2f, canBypassSideCrumbleDelay: true);
                            level.Add(crumblePlatform3);
                            level.Displacement.AddBurst(crumblePlatform3.Center, 0.5f, 8f, 32f, 0.5f);
                            crumblePlatform4 = new CustomCrumbleBlock(bounds + new Vector2(176f, 152f), Vector2.Zero, 16, 8, 2f, 0.6f, 0.6f, false, -1, texture: "objects/Xaphan/CustomCrumbleBlock/abyss_c", lightOccludeValue: 0.2f, canBypassSideCrumbleDelay: true);
                    ...
                    if (DashBootsCollected())
                    {
                        ...
                        XaphanModule.ModSettings.DashBoots = false;
                        HadDashBoots = true;
                    }
                    if (level.Session.GetFlag("boss_Challenge_Mode"))
                    {
