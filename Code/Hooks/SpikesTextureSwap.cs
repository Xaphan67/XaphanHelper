...
namespace Celeste.Mod.XaphanHelper.Hooks
{
    internal class SpikesTextureSwap
    {
        ...
        {
            if (SaveData.Instance.LevelSetStats.Name == "Xaphan/0" && XaphanModule.ModSaveData.GlobalFlags.Contains("Xaphan/0_Ch4_Escape_Complete" + (XaphanModule.PlayerHasGolden ? "_GoldenStrawberry" : "")) && SaveData.Instance.CurrentSession.Area.ChapterIndex == 5)
            {
