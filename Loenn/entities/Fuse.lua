...
function Fuse.sprite(room, entity)
    ...
    local frame = entity.directory .. "/frame" or "objects/XaphanHelper/Fuse/frame"
    local depth = -19999
...
function Fuse.onResize(room, entity, offsetX, offsetY, directionX, directionY)
