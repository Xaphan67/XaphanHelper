...
local FGTilesJumpthru = {}

FGTilesJumpthru.name = "XaphanHelper/FGTilesJumpthru"
FGTilesJumpthru.depth = -9000
FGTilesJumpthru.canResize = {true, false}
FGTilesJumpthru.fieldInformation = {
    texture = {
        options = {"wood", "dream", "temple", "templeB", "cliffside", "reflection", "core", "moon"},
        editable = true
    },
    surfaceIndex = {
...
FGTilesJumpthru.placements = {
    name = "FGTilesJumpthru",
    data = {
        width = 8,
        texture = "wood",
        surfaceIndex = 8
...
function FGTilesJumpthru.sprite(room, entity)
...
function FGTilesJumpthru.selection(room, entity)
    return utils.rectangle(entity.x, entity.y, entity.width, 8)
end

return FGTilesJumpthru